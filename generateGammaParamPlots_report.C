/**
 * generate historgrams for MC & data file.
 * For MC, it expects to have stage5 combined tree input
 * For data, it expects to have stage6 file & a list of stage5 combined tree files
 *
...
//
//#include "/a/home/tehanu/ap3115/software/veritas/vegas-v2_5_4/common/include/VAShowerData.h"
//#include "/a/home/tehanu/ap3115/software/veritas/vegas-v2_5_4/common/include/VASimulationDataClasses.h"
//#include "/a/home/tehanu/ap3115/software/veritas/vegas-v2_5_4/common/include/VAParameterData.h"
...
//  const int nfiles = nf;
  ...
  for(int i=0; i<NumToRead; i++){
    ...
    if( !isData || rOnEvent || rOffEvent ){
      ...
      //fill per telescope information
