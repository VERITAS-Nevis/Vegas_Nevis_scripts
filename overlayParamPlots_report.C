 ...
 * Plots are printed to location specified in line 271, currently set to dribeiro dir in Tehanu
...
//        cout << NameOfParamsTel[j] <<" " << n <<" " <<norm2 <<" " << h1ParamsPerTelCombined2[j][ntel][reportTypeId]->GetBinError(n) <<" " << h1ParamsPerTelCombined2[j][ntel][reportTypeId]->GetBinError(n)/(norm2) <<endl; 
  ...
  string outfile = "/a/data/tehanu/dribeiro/Crab/Overlay_geo"; // location where plot is printed to
  string buffout;
