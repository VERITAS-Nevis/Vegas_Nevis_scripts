		    ...
		    string outroot="" )
{
  ...
  //TF1 *fit1 = new TF1( "fit1", "[0]*pow(x/[3],[1]+[2]*log10(x))", emin, emax );
  //TF1 *fit2 = new TF1( "fit2", "[0]*pow(x/[3],[1]+[2]*log10(x))", emin, emax );
  ...
  whipple->SetLineColor( 6 );
  whippleflat->SetLineColor( 6 );
  hegra->SetLineColor( 6 );
  hegraflat->SetLineColor( 6 );
  hess->SetLineColor( 6 );
  hessflat->SetLineColor( 6 );
  magic->SetLineColor( 6 );
  magicflat->SetLineColor( 6 );
  alex->SetLineColor( 6 );
  alex->SetLineStyle( 2 );
  alexflat->SetLineColor( 6 );
  ...
  leg->AddEntry( whipple, "Published Results", "l" );
  ...
  TH2F *hf = new TH2F( "hf", "", 100, 1, 10, 100, 1.e-10, 1.e-6 );
  TH2F *hg = new TH2F( "hg", "", 100, 1, 10, 100, 1.e-8, 0.5e-6 );
  ...
  hg->GetYaxis()->SetTitleOffset(1.4);
