...
cd /a/home/tehanu/ap3115/Analysis/
...
#    -EC_maxPsiSq=2.89 \
#    -S6A_TestPositionRA=266.254 -S6A_TestPositionDEC=-29.0405 \
#     -S6A_RingSize=0.1732 \
#    -TelCombosToDeny=ANY2 \
#    -MaxHeightLower=7 \
#    -MeanScaledWidthUpper=1.1 -MeanScaledLengthUpper=1.3 \
#    -MeanScaledWidthLower=0.05 -MeanScaledLengthLower=0.05 \
#    -S6A_LookupFileName=/data/humensky/EAs/vegas-2.5/ea_Oct2012_oa_ATM21_vegasv250rc5_7sam_050off_s400t2_std_MSW1p1_MSL1p3_MH7_ThetaSq0p01_LZA.root \
#
#    For IC443:
#    -S6A_TestPositionRA=94.18 -S6A_TestPositionDEC=22.55 \
#    -S6A_TestPositionRA=94.47 -S6A_TestPositionDEC=22.49 \
#    -S6A_TestPositionRA=94.39 -S6A_TestPositionDEC=22.76 \
#    -S6A_LookupFileName=/data/humensky/SgrA/Andy/eff_Area_ua_0.13.root \
$vroot/bin/vaStage6 \
    -S6A_TestPositionRA=94.39 -S6A_TestPositionDEC=22.76 \
    ...
    -S6A_ExcludeSource=1 -S6A_SourceExclusionRadius=0.5 \
    -S6A_RingSize=0.13 \
    -S6A_NumRings=0 \
    -EC_maxPsiSq=2.89 \
