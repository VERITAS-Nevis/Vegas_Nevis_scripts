...
#
#    For IC443:
#    -S6A_TestPositionRA=94.22 -S6A_TestPositionDEC=22.55 \
$vroot/bin/vaStage6 \
    -S6A_TestPositionRA=227.2875 -S6A_TestPositionDEC=67.2225 \
    -OverrideEACheck=1    -S6A_Batch=1 \
    -EA_UpdateModifiedEffectiveArea=1 -EA_RealSpectralIndex=-2.5 \
